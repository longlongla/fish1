...
public class EndView extends BaseView{
	...
	private String startGame = "Try Again";	// 按钮的文字
	private String exitGame = "Give Up";
	...
	public void drawSelf() {
		...
		try {
			...
			float textlong = paint.measureText("Total:"+String.valueOf(score));
			canvas.drawText("Total:"+String.valueOf(score), screen_width/2 - textlong/2, screen_height/2 - 100, paint);
		} catch (Exception err) {
			err.printStackTrace();
		} finally {
			if (canvas != null)
